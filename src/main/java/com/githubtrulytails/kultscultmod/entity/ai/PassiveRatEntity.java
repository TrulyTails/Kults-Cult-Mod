...
public class PassiveRatEntity extends PathAwareEntity {
    protected PassiveRatEntity(EntityType<? extends PassiveRatEntity> entityType, World world) {
    ...
    public EntityData initialize(
        ...
        if (entityData == null) {
            entityData = new PassiveRatEntity.PassiveData(true);
        }

        PassiveRatEntity.PassiveData passiveData = (PassiveRatEntity.PassiveData)entityData;
    ...
    public static class PassiveData implements EntityData {
        ...
        public PassiveData(float babyChance) {this(true, babyChance); }
